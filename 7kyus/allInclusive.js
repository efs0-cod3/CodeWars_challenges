...
console.log(
  containAllRotsS("bsjq", ["bsjq", "qbsj", "sjqb", "twZNsslC", "jqbs"])
);

function containAllRotsB(strng, arr) {
  // your code
  let strToArr = [...strng];
  const allRotations = [];
  ...
  return allRotations.map((el) => el).every((el) => arr.includes(el));
}
console.log(
  containAllRotsB("bsjq", ["bsjq", "qbsj", "sjqb", "twZNsslC", "jqbs"])
);
